      ...
      {grad && (
        <defs>
          <linearGradient id={gid} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor={LOGO.corA} />
            <stop offset="100%" stopColor={LOGO.corB} />
            {/* gira em torno do centro do viewBox */}
            <animateTransform attributeName="gradientTransform" type="rotate"
              from="0 0.5 0.5" to="360 0.5 0.5"
              dur={`${LOGO.velocidade}s`} repeatCount="indefinite" />
          </linearGradient>
        </defs>
      )}
